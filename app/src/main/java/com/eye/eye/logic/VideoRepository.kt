...
import com.eye.eye.logic.dao.VideoDao
...
class VideoRepository (private val dao: VideoDao, private val network: EyeNetWork) {

    suspend fun refreshVideoReplies(repliesUrl:String) = requestVideoRelies(repliesUrl)
    ...
    private suspend fun requestVideoRelies(repliesUrl: String) = withContext(Dispatchers.IO){
        coroutineScope {
    ...
    companion object {
        ...
        fun getInstance(dao: VideoDao, network: EyeNetWork): VideoRepository {
            if (repository == null) {
