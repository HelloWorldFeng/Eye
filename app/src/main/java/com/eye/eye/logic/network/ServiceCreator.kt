...
import com.eye.eye.extension.logV
import com.eye.eye.extension.screenPixel
import com.eye.eye.ui.common.callback.GsonTypeAdapterFactory
...
object ServiceCreator {
    ...
    class LoggingInterceptor : Interceptor {
        ...
        override fun intercept(chain: Interceptor.Chain): Response {
            ...
            logV(TAG, "Received response for  ${response.request().url()}\n in ${(t2 - t1) / 1e6} ms\n${response.headers()}")
            return response
        }
    ...
    class BasicParamsInterceptor : Interceptor {
        override fun intercept(chain: Interceptor.Chain): Response {
            ...
            val url = originalHttpUrl.newBuilder().apply {
                ...
                addQueryParameter("vc", GlobalUtil.eyeVersionCode.toString())
                addQueryParameter("vn", GlobalUtil.eyeVersionName)
