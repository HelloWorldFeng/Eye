...
import com.eye.eye.ui.common.holder.RecyclerViewHelp
import com.eye.eye.ui.common.holder.TextCardViewHeader4ViewHolder
import com.eye.eye.ui.common.holder.VideoSmallCardViewHolder
...
* 视频详情-相关推荐列表的适配器
* */
class NewDetailRelatedAdapter(private val activity: NewDetailActivity, val dataList: List<VideoRelated.Item>, private var videoInfoData: NewDetailActivity.VideoInfo?):RecyclerView.Adapter<RecyclerView.ViewHolder>() {
            ...
            is CustomHeaderViewHolder -> {
                videoInfoData?.let {
                    holder.run {
                        ...
                        setOnClickListenter(ivCollectionCount, tvCollectionCount, ivShare, tvShareCount, ivCache, tvCache, ivFavorites, tvFavorites, tvFollow) {
                            when (this) {
