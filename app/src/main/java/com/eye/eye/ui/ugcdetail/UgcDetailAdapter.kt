...
class UgcDetailAdapter(val activity: UgcDetailActivity,var dataList:List<CommunityRecommend.Item>):RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return when(item.type){
            com.eye.eye.ui.community.commend.CommendAdapter.STR_COMMUNITY_COLUMNS_CARD ->{
                if (item.data.dataType == com.eye.eye.ui.community.commend.CommendAdapter.STR_FOLLOW_CARD_DATA_TYPE) com.eye.eye.ui.community.commend.CommendAdapter.FOLLOW_CARD_TYPE
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = when (viewType) {
        com.eye.eye.ui.community.commend.CommendAdapter.FOLLOW_CARD_TYPE -> FollowCardViewHolder(R.layout.item_ugc_detail.inflate(parent))
        ...
        when (holder) {
            is FollowCardViewHolder ->{
                ...
                holder.run {
                    ...
                    tvCollectionCount.text = item.data.content.data.consumption.replyCount.toString()
                    setOnClickListenter(tvPrivateLetter,tvFollow,ivCollectionCount,tvCollectionCount,ivReply,tvReplyCount, ivFavorites, tvFavorites, ivShare){
                        when (this) {
                ...
                when (item.data.content.type) {
                    com.eye.eye.ui.community.commend.CommendAdapter.STR_VIDEO_TYPE ->{
                    ...
                    com.eye.eye.ui.community.commend.CommendAdapter.STR_UGC_PICTURE_TYPE->{
