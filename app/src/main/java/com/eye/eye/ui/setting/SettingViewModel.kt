...
class SettingViewModel : ViewModel() {
    ...
    var rbDailyOpen: Boolean
        get() = sharedPreferences.getBoolean("dailyOff",true)
        set(value) = sharedPreferences.edit { putBoolean("dailyOff", value) }
        ...
        when (view.id) {
            ...
            R.id.tvVideoFunStatement, R.id.tvCopyrightReport -> {
                WebViewActivity.start(
                    view.context,
                    WebViewActivity.DEFAULT_TITLE,
                    Const.Url.VIDEO_FUNCTION_STATEMENT,
                    false,
                    false
                )
            }
