...
class LoginActivity : BaseActivity() {
    ...
    private fun initTitleBar() {
        ...
        tvRightText.setTextColor(ContextCompat.getColor(this, R.color.white))
    ...
    private fun initListener() {
        setOnClickListenter(tvRightText, tvUserLogin, tvUserRegister, tvAuthorLogin, tvUserAgreement, tvUserLogin, ivWechat, ivSina, ivQQ) {
            when (this) {
                tvRightText -> {
